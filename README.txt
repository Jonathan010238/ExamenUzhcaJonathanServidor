...
a persistence unit "ExamenUzhcaJonathanServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenUzhcaJonathanServidor\pom.xml":
...
artifact ("ExamenUzhcaJonathanServidor.war") is already built. You can build
